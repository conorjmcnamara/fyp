...
def compute_and_save_pagerank_scores(graph_path: str, rerank_scores_path: str) -> None:
...
def compute_and_save_hits_scores(graph_path: str, rerank_scores_path: str) -> None:
    graph: nx.DiGraph = read_obj(graph_path)
